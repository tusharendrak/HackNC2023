...
import com.example.hacknc.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Log.d("shreyash","onDataChanged"+snapshot);
    ...
    private void addMarkersToMap(List<LatLng> latLngsList) {
        LatLng temp = new LatLng(35.91,-79.05);
        Log.d("shreyash","received latlngList:"+latLngsList);
        for(int i =0;i<latLngsList.size();i++){
            mMap.addMarker(new MarkerOptions().position(latLngsList.get(i)).title(""));
